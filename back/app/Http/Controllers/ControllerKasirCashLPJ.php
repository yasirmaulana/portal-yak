...
class ControllerKasirCashLPJ extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('lpj.kc_lpj', compact('details')); 
    }
    ...
    public function show($nomor)
    {
        ...
        return view('lpj.kc_lpjdetail', compact('no', 'namaPengaju', 'details'));
    }
    ...
    public function edit($nomor)
    {
        ...
        return redirect()->route('kclpj.index');
    }
